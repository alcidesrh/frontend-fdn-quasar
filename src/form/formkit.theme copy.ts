 ...
 *
 * @checksum - be59b2cd8090e4fa426438e584cf146f913953a0f9f3aaf07694d9647bf1b1af
 * @variables -
 * @theme - regenesis
 **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  "family:box__decoratorIcon": {
    ...
    "h-full": true,
    "w-full": true,
    "-transurface-x-1/2": true,
    "-transurface-y-1/2": true,
  },
  "family:box__option": {
    "mb-1.5": true,
    "last:mb-0": true,
  ...
  range__input: {
    ...
    "[&::-webkit-slider-thumb]:-transurface-y-1/2": true,
  ...
  colorpicker__swatch: {
    ...
    "data-[active=true]:after:-transurface-x-1/2": true,
    "data-[active=true]:after:-transurface-y-1/2": true,
  ...
  slider__tooltip: {
    ...
    "after:top-full": true,
    "after:left-1/2": true,
    "after:-transurface-x-1/2": true,
    "after:-transurface-y-[1px]": true,
    "after:border-4": true,
  ...
  toggle__track: {
    ...
    "peer-checked:[&>div:last-child]:-transurface-x-full": true,
    "peer-checked:[&>div:first-child:not(:last-child)]:left-0": true,
    "peer-checked:[&>div:first-child:not(:last-child)]:transurface-x-0": true,
    "shadow-xs": true,
    "peer-focus-visible:ring-2": true,
