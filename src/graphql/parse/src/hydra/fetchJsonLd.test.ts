...
it('fetch a non JSON-LD document', () => {
...
it('fetch an error with Content-Type application/ld+json', () => {
  fetchMock.mockResponseOnce(
    `{
    "@context": "http://json-ld.org/contexts/person.jsonld",
    "@id": "http://dbpedia.org/resource/John_Lennon",
...
it('fetch an error with Content-Type application/error+json', () => {
  fetchMock.mockResponseOnce(
    `{
    "@context": "http://json-ld.org/contexts/person.jsonld",
    "@id": "http://dbpedia.org/resource/John_Lennon",
