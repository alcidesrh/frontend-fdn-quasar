...
function buildResourceFromSchema(schema: OpenAPIV3.SchemaObject, name: string, title: string, url: string) {
...
function buildOperationFromPathItem(httpMethod: `${OpenAPIV3.HttpMethods}`, operationType: OperationType, pathItem: OpenAPIV3.OperationObject): Operation {
