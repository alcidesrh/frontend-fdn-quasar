    ...
    <draggable-fields v-model="localFields" type="form">
      <template #content="{ element }">
        ...
        <div class="w-50px">
          <icon
            name="html"
            @click="editInputProps(element)"
            class="text-34px ml-10px"
          />
        </div>
      </template>
    </draggable-fields>
        ...
        <q-card-section>
          ...
          <q-scroll-area style="height: 200px; max-width: 400px">
            <div
              ...
              v-if="
                propsDialog.field.inputProps &&
                propsDialog.field.inputProps.length
              "
            ...
            >
              ...
              <div class="col flex items-center">
                <icon
                  name="delete"
                  @click="propsDialog.field.inputProps.splice(i, 1)"
                />
              </div>
              <div class="col-8">
                <q-separator />
...
function addAttrb() {
  ...
  if (!propsDialog.value.field.inputProps) {
    ...
    (temp = propsDialog.value.field.inputProps.find(
      (v) => typeof v[key.value] != "undefined",
    ))
  ) {
